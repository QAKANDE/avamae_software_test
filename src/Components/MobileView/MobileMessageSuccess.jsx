...
import "../../Styles/Mobile/MobileMessageSuccess.scss";

class MobileMessageSuccess extends Component {
  state = {};
  render() {
    return (
      <>
        <div className="mobile-message-sent-wrapper">
          <div className="mobile-svg-wrapper">
            <div className="mobile-svg-container">
              <div className="mobile-svg-outer_circle">
                <svg
...
export default MobileMessageSuccess;
