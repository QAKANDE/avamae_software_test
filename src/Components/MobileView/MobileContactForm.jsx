...
import "../../Styles/Mobile/MobileContactForm.scss";
      ...
      <>
        <div>
          ...
          <small>
            ...
            veritatis, sint tenetur iusto nisi maiores eum reprehenderit
          </small>
            ...
            <form autoComplete="off">
              ...
              {this.state.includeAddressDetails === true ? (
                <div>
                  ...
                  <div className="mobile-contact-us-row">
                    <div className="mobile-contact-us-col-6">
                    ...
                    <div className="mobile-contact-us-col-6">
                      <div className="stateCounty">
                        ...
                        {errors.stateCounty.length > 0 && (
                          <span className="error">{errors.stateCounty}</span>
                        )}
                      </div>
                    </div>
                  </div>
              ...
              {this.state.errorInForm === true ? (
                <div className="error-message">
                  ...
                  <p className="error-text">Please complete required fields</p>
                </div>
              ) : (
                <div></div>
              )}
